 ...
 * - $tab_type: The type of tab to use.
 * - $tab_position: The position of the tabs.
 * - $tab-fade: Whether to use the fading effect.
 *
...
<div id="views-bootstrap-tab-<?php print $id ?>" class="<?php print implode(' ', $classes); print $wrapper_classes; ?>">
