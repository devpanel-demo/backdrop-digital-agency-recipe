 ...
 * - $indicators: Whether to display carousel indicators.
 * - $first_key: Key of the first row.
 * - $navigation: Whether to display the navigation controls.
 *
...
<div id="views-bootstrap-carousel-<?php print $id ?>" class="<?php print implode(' ', $classes) ?>" <?php print backdrop_attributes($attributes) ?>>
  <?php if ($indicators): ?>
    <!-- Carousel indicators -->
